...
\begin{frame}{Belief Mass Distribution and Uncertainty Mass}
    Now, I told you that our urn has 10 colored balls. One ball is \red, 2 are \blue, and 3 are \green\\ or \blue. Therefore, you know nothing about 4 balls. \\~\\
...
\begin{frame}{Comparison with Imprecise Probabilities}
    ...
    The Imprecise Dirichlet Model (IDM) is a method for determine upper and lower probabilities produced by setting the
minimum and maximum base rates in the Dirichlet PDF. \\~\\
