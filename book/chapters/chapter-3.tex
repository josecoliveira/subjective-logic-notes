...
The projected probability distribution $\mathbf{P}_X$ of hyper-opinions can be expressed as
\begin{equation}
...
\subsection{Alternative Opinion Representations}
...
\subsubsection{Qualitative Opinion Representation}
